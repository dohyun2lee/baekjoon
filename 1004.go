...
func main() {
	...
	for i := 0; i < t; i++ {
		...
		for j := 0; j < n; j++ {
			...
			isStartContained := checkPlanet(startX, startY, planetX, planetY, r)
			isEndContained := checkPlanet(endX, endY, planetX, planetY, r)
...
func checkPlanet(x, y, planetX, planetY, r int) bool {
